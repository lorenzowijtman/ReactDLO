...
class UserSettings extends Component {
  ...
  componentDidMount() {
    ...
    this.props.updateTitle('Instellingen');
  }
      ...
      if (formError) {
        ...
        if (oldpassword !== '' && password !== '' && passwordRepeat !== '') {
          if (password === passwordRepeat) {
            ...
            this.setState({
              alert: {
                message: 'Wachtwoord gewijzigd! (U wordt over 3 seconden uitgelogd.)',
          ...
          this.setState({
            alert: {
              message: 'Gegevens succesvol gewijzigd! (U wordt over 3 seconden doorgestuurd)',
              type: toast.TYPE.SUCCESS,
              status: true,
            },
          });
